...
const PendaftaranKUA: React.FC = () => {
    return (
        ...
        style={{
            backgroundImage: `url("/kua.png")`, // Ganti dengan path image Anda
        ...
        >
            <div
                ...
                style={{ backdropFilter: 'blur(8px)' }} // Opsional untuk menambahkan efek blur
            >
                <div className="p-8 bg-gray-100 font-sans">
                    <h1 className="text-2xl font-bold mb-4">Pendaftaran KUA</h1>
                    <p className="mb-4">
                        Pernikahan adalah ibadah terlama bagi sepasang suami dan istri.
                        Pernikahan menjadi awal kehidupan banyak orang sehingga dianggap
                        sesuatu yang sakral. Tujuan menikah bagi setiap orang tidak
                        sama, bahkan dua individu dalam sebuah hubungan juga mempunyai
                        tujuan yang berbeda. Yuk simak dokumen persyaratan yang dibawa
                        calon pengantin ke KUA!
                    </p>

                    <h2 className="text-xl font-semibold mt-6 mb-2">
                        Dokumen yang dibawa calon pengantin ke KUA
                    </h2>
                    ...
                    <ol className="list-decimal list-inside bg-white p-4 rounded shadow">
                        ...
                        <li>
                            Surat Rekomendasi dari KUA setempat (jika pernikahan di luar
                            wilayah KUA)
                        </li>
                    </ol>
                </div>
