...
const CulinaryFashionPage = () => {
  ...
  const items = [
    ...
    { name: 'Ical Craft Lampung', category: 'KERAJINAN', image: '/ical_craft.png', link: 'https://maps.app.goo.gl/AWLgJRejp1GPFPyi9', instagram: 'https://instagram.com/nuwa_ical_art', instagramUsername: 'nuwa_ical_craft' },
    { name: 'Kovee', category: 'KULINER', image: '/kovee.jpg', link: 'https://maps.app.goo.gl/fzcX13awDqs5Rhrx5', instagram: 'https://instagram.com/kove.idn', instagramUsername: 'kove.idn' },
    { name: 'Kahut Sigerbori', category: 'KERAJINAN', image: '/kahut.jpg', link: 'https://maps.app.goo.gl/Bx4ygouqC8WiMhSU8', instagram: 'https://instagram.com/kahut_sigerbori', instagramUsername: 'kahut_sigerbori' },
    { name: 'Laancbake', category: 'KULINER', image: '/laancbake.jpg', link: 'https://maps.app.goo.gl/LFVv96u7qaCGTWNr9', instagram: 'https://instagram.com/laancbake', instagramUsername: 'laancbake' },
    { name: 'Zeliaze Ethnic Galery', category: 'KERAJINAN', image: '/zeliaze.jpg', link: 'https://maps.app.goo.gl/WwThzBX6pzHDQDb16', instagram: 'https://instagram.com/zeliaze_tapis_lampung', instagramUsername: 'zeliaze_tapis_lampung' },
    { name: 'Otsky', category: 'FASHION', image: '/otsky.jpg', link: 'https://maps.app.goo.gl/gznH3petqeDP5zhQ9', instagram: 'https://instagram.com/otsky.store', instagramUsername: 'otsky.store' },
    { name: 'Studio Curly', category: 'FASHION', image: '/curly.jpg', link: 'https://maps.app.goo.gl/aUptwnP88FsRx7YW6', instagram: 'https://instagram.com/nailartbandarlampung', instagramUsername: 'nailartbandarlampung' },
    { name: 'Lady Fame', category: 'FASHION', image: '/lady_fame.jpg', link: 'https://maps.app.goo.gl/XZHUvoJDzxANh5ha8', instagram: 'https://instagram.com/ladyfameshop', instagramUsername: 'ladyfameshop' },
    { name: 'Minty Label', category: 'FASHION', image: '/minty.jpg', link: 'https://maps.app.goo.gl/Ezs1F2fTHzabND3T8', instagram: 'https://instagram.com/mintylabel', instagramUsername: 'mintylabel' },
    { name: 'Jee Florist', category: 'KERAJINAN', image: '/jee.jpg', link: 'https://maps.app.goo.gl/GR6RJanxupFuRGCU6', instagram: 'https://instagram.com/jee_florist', instagramUsername: 'jee_florist' },
  ];
