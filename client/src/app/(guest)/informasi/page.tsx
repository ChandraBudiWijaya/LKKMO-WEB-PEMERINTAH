            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <a
                    ...
                    <div className="p-6">
                        ...
                        <p className="text-gray-600 text-center">
                            Lembaga formal yang berisi informasi Institut
                            Pendidikan di daerah Bandar Lampung dan sekitarnya
                            untuk mendukung informasi pendidikan.
                        </p>
                ...
                <a
                    ...
                    <div className="p-6">
                        ...
                        <p className="text-gray-600 text-center">
                            Unit usaha lokal yang menawarkan produk atau jasa
                            untuk memenuhi kebutuhan masyarakat setempat dan
