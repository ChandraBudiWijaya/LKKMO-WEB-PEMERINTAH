import InstansiCard from '@/components/instansiCard';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gray-200 py-2 px-6">
        <p className="text-sm text-gray-600">Informasi &gt; Daftar Institusi</p>
      </div>

      {/* Header Section */}
      <div className="container mx-auto text-center py-12">
        <h1 className="text-3xl md:text-5xl font-extrabold text-gray-800">Daftar Institusi di Bandar Lampung</h1>
      </div>
