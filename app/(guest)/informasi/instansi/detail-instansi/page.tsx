    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <header className="text-black p-6">
        <nav className="text-sm text-black mb-2">
          Informasi &gt; Daftar Institusi &gt; Institut Teknologi Sumatera
        </nav>
        <h1 className="text-4xl font-bold">Institut Teknologi Sumatera</h1>
      </header>
      ...
      <div className="max-w-4xl mx-auto py-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="text-center">
            ...
            />
            <p className="text-gray-700">Prof. Dr. I Nyoman Pugeg Aryantha</p>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="relative w-full h-64">
              <a target='blank' href="https://maps.app.goo.gl/Pco8MchziZ9yeyxRA">
              <img
              src="/lokasiitera.png"
              alt="MapsItera"
            ...
            <p className="text-gray-700 mt-4">Jalan Terusan Ryacudu, Way Hui, Kecamatan Jati Agung, Lampung Selatan</p>
          </div>
        </div>
      </div>
